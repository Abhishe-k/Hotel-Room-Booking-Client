...
"      ");            
            out.println("<link rel=\"stylesheet\" href=\"https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.7.0/animate.min.css\"></head>");
            ...
            //int cid = client.getCustomerId(nm, ph, em);
            //getServletContext().setAttribute("cid",client.getCustomerId(nm, ph, em));
            out.println("<h1 class='center-align'>Your Booking Details </h1><div class='container'><br/><br/><br/>");
            out.println("<table class='striped z-depth-5 animated lightSpeedIn'><tr>");
             out.print("<th colspan='5'>Room No</th>");
                ...
                out.print("<th colspan='5'>Stay in days</th><th></th><th></th></tr>");
