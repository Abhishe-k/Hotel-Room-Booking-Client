...
"</style>");
            ...
            out.println("</head>");
            out.println("<body><center><form method='POST' action='http://localhost:8080/RoomBookingApplication/ChangeDate' class='center-align'>");
...
"</div>");
            ...
            out.println("<br><br><br><button type='submit'>Update</button>");
